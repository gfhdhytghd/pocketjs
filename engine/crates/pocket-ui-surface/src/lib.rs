...
//! renderer dependency: desktop wgpu, PocketBook inkview, and the Kindle
//! framebuffer host all build on it, pairing it with their own DrawList
//! backends (docs/RUNTIMES.md — a runtime is ⟨Cores, Surfaces, Guest⟩; this
//! crate is the Surface mechanism).
