...
import { Input } from "../apps/voxelmon/game/input.ts";
import { encodeGlyphs, glyphLen, MAX_COLS } from "../apps/voxelmon/game/ui/tiles.ts";
import { GameMap } from "../apps/voxelmon/game/world/map.ts";
import { computeNeighbors } from "../apps/voxelmon/game/world/overworld.ts";
import { paginate, Textbox } from "../apps/voxelmon/game/world/textbox.ts";
import { parseTape, TapePlayer, TapeStallError } from "../apps/voxelmon/game/sim/tape.ts";
